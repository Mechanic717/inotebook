        ...
        try {
            const response = await fetch(`${host}/api/notes/fetchallnotes`, {
                ...
                headers: {
                    ...
                    'auth-token': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNjZlMzM3OWE2N2QyZmJmM2M1ODAyZjA4In0sImlhdCI6MTcyNjE2Njk3N30.FVCuhd4t4LtSsFU2LxMIrpmfesnl1HgXN63Wvz1pEDk'
                }
            });
